...
Name=$(curl https://raw.githubusercontent.com/asutunnel/permission/main/ipmini | grep $MYIP | awk '{print $2}')
...
botBackup() {
	...
	sleep 1
    cp -r /var/lib/Andre-Sakti/ backup/Andre-Sakti &>/dev/null
...
restoreBot() {
	...
	sleep 1
    cp -r Andre-Sakti /var/lib/ &>/dev/null
...
botbckpBot_menu() {
	...
	echo -e " ${Blue}╰═══════════════════════════════════════════════════════╯${NC}"
    echo -e " ${Blue}╭═══════════════════════════════════════════════════════╮${NC}"
    echo -e " ${Blue}│$NC ${green} VPS Data Backup By ALVI CELL TUNNELING"
    echo -e " ${Blue}│$NC"
