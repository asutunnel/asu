...
curl -sS https://raw.githubusercontent.com/asutunnel/asu/main/ssh/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/asutunnel/asu/main/ssh/nginx.conf"
mkdir -p /home/vps/public_html
/etc/init.d/nginx restart

# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/asutunnel/asu/main/ssh/newudpgw"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/asutunnel/asu/main/issue.net"
chmod +x /etc/issue.net
echo "Banner /etc/issue.net" >> /etc/ssh/sshd_config
sed -i 's@DROPBEAR_BANNER=""@DROPBEAR_BANNER="/etc/issue.net"@g' /etc/default/dropbear

#install bbr dan optimasi kernel
wget https://raw.githubusercontent.com/asutunnel/asu/main/ssh/bbr.sh && chmod +x bbr.sh && ./bbr.sh
...
wget -O user-lock "https://raw.githubusercontent.com/asutunnel/asu/main/ssh/user-lock.sh"
wget -O user-unlock "https://raw.githubusercontent.com/asutunnel/asu/main/ssh/user-unlock.sh"
...
wget -O menu-backup "https://raw.githubusercontent.com/asutunnel/asu/main/backup/menu-backup.sh"
