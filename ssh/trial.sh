...
echo -e "\e[1;36m__________________________________________\033[0m" | tee -a /etc/log-create-user.log
echo -e "\033[0;34m=================================================\033[0m"
echo -e "\E[0;41;36m            TRIAL AKUN SSH              \E[0m"
echo -e "\033[0;34m=================================================\033[0m"
echo -e "Username    : $Login"
echo -e "Password    : $Pass"
echo -e "Aktif Selama: 30 Menit"
echo -e "\033[0;34m================================================033[0m"
echo -e "SSH-SSL-WS  : $domen:80@$Login:$Pass"
echo -e "SSH-SSL-WS  : $domen:443@$Login:$Pass"
echo -e "IP          : $IP"
echo -e "domain      : $domen"
echo -e "ns domain   : $NS"
...
echo -e "\033[0;34m=================================================\033[0m"
echo ""
echo "killtrial ssh ${Login}" | at now +30 minutes &> /dev/null
fi
