...
Name=$(curl -sS https://raw.githubusercontent.com/ALVIICELL/asutunnel/main/ipmini | grep $MYIP | awk '{print $2}')
...
echo -e ""
echo -e "     ${BICyan}[${BIWhite}01${BICyan}] Menu Trojan Go    "
echo -e "     ${BICyan}[${BIWhite}02${BICyan}] Menu Trojan ws    "
echo -e " ${BICyan}└─────────────────────────────────────────────────────┘${NC}"
