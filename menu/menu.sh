...
clear      
		    ...
		    echo -e "╘━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╛${NC}" | lolcat 
                    echo -e "${Kcyan}┌───────────────────────────────────────────┐${NC}" 
                    echo -e "${Kcyan}│${NC} ${white} IP VPS  ${NC}: $IPVPS"      "${Kcyan}│${NC}"
		    echo -e "${Kcyan}│${NC} ${white} Domain  ${NC}: $domain"     "${Kcyan}│${NC}"
                    echo -e "${Kcyan}│${NC} ${white} CPU     ${NC}: $cpu_usage"  "${Kcyan}│${NC}"
                    echo -e "${Kcyan}│${NC} ${white} RAM     ${NC}: $tram Mb"    "${Kcyan}│${NC}"
		    echo -e "${Kcyan}│${NC} ${white} ISP     ${NC}:$(curl -s ipinfo.io/org | cut -d " " -f 2-10 )" "${Kcyan}│${NC}"
                    echo -e "${Kcyan}└───────────────────────────────────────────┘${NC}"  
                    ...
                    echo -e "${Kcyan}└───────────────────────────────────────────┘${NC}"
                    echo -e "${Kcyan}┌───────────────────────────────────────────┐${NC}"
		    echo -e "${Kcyan}│${NC}${whiteK}         Version : ${NC}${MK}3.0 last Update"        "${Kcyan}│${NC}"
     		    echo -e "${Kcyan}│${NC}${whiteK}         order by: ${NC}${MK}Asu Tunnel"             "${Kcyan}│${NC}"
		    echo -e "${Kcyan}│${NC}${whiteK}         Whatsapp: 📞${NC}${MK}08xxxx"               "${Kcyan}│${NC}"
                    echo -e "${Kcyan}│${NC}${whiteK}         Client  : ${NC}${MK}$Name${NC}"             "${Kcyan}│${NC}"
                    echo -e "${Kcyan}│${NC}${whiteK}         Xpired  : ${NC}${MK}($Exp) $exp2 days ${NC}""${Kcyan}│${NC}"
                    echo -e "${Kcyan}└───────────────────────────────────────────┘${NC}"
                    echo -e "${Kcyan}┌───────────────────────────────────────────┐"
                    echo -e "${Kcyan}│${NC}${Kbiru} [•1]${NC} 👉 ${red} SSH${NC}        " "${Kbiru}[•6]${NC} 👉 ${red} CHECK RUNNING${NC}"   "${Kcyan}│${NC}"
                    ...
                    echo -e "${Kcyan}│${NC}${Kbiru} [•4]${NC} 👉 ${red} TROJAN-GO${NC}  " "${Kbiru}[•9]${NC} 🔐 ${red} SET PASW VPS${NC} "   "${Kcyan}│${NC}"
