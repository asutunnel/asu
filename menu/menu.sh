...
clear      
		    ...
		    echo -e "${Kcyan}│${NC}${whiteK}         Whatsapp: 📞${NC}${MK}08xxxx"		"${Kcyan}│${NC}"
                    ...
                    echo -e "${Kcyan}└───────────────────────────────────────────┘${NC}"
                    echo -e "${Kcyan}┌───────────────────────────────────────────┐"
                    echo -e "${Kcyan}│${NC}${Kbiru} [•1]${NC} 👉 ${red} SSH${NC}        " "${Kbiru}[•6]${NC} 👉 ${white} CHECK RUNNING${NC}"   "${Kcyan}│${NC}"
                    echo -e "${Kcyan}│${NC}${Kbiru} [•2]${NC} 👉 ${red} VMESS${NC}      " "${Kbiru}[•7]${NC} 👉 ${white} RESTR SERVICE${NC}"   "${Kcyan}│${NC}"  
                    echo -e "${Kcyan}│${NC}${Kbiru} [•3]${NC} 👉 ${red} VLESS${NC}      " "${Kbiru}[•8]${NC} 👉 ${white} BACKUP MENU${NC}  "   "${Kcyan}│${NC}"
