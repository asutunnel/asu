...
echo -e " "
echo -e "         ${white}[•1]${NC} ${cyan}Create Account Trojan Goo${NC}"
echo -e "         ${white}[•2]${NC} ${cyan}Trial Account Trojan Go${NC}"
echo -e "         ${white}[•3]${NC} ${cyan}Extending Account Trojan Go Active Lifet${NC}"
echo -e "         ${white}[•4]${NC} ${cyan}Delete Account Trojan Go${NC}"
echo -e "         ${white}[•5]${NC} ${cyan}Check User Login Trojan Go${Nc}"
