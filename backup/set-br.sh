...
echo "Checking VPS"
# Link Hosting Kalian
asutunnel="raw.githubusercontent.com/asutunnel/asu/main/backup"

apt install rclone -y
printf "q\n" | rclone config
wget -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/asutunnel/asu/main/backup/rclone.conf"
